(function () {
  ...
  container.setAttribute(
    'style',
    'display: flex; justify-content: center; align-items: center; background-color: #fff; padding: 1rem; margin-top: auto 0; width: 100%; box-shadow: 0 0.0625rem 0.1875rem #00000014; border-radius: 0.25rem'
  );
